...
fun SettingsMainScreen(
    ...
    onNavigate: (VoyagerSettingsScreen) -> Unit,
    onBack: () -> Unit,
    ...
    SettingsScreen(
        state = uiState,
        page = com.misaka.hoshinoschedule.ui.settings.SettingsPage.Main,
        snackbarHostState = snackbarHostState,
        onNavigate = { page ->
            when (page) {
                is com.misaka.hoshinoschedule.ui.settings.SettingsPage.Main -> {}
                is com.misaka.hoshinoschedule.ui.settings.SettingsPage.Category -> 
                    onNavigate(VoyagerSettingsScreen.Category(page.category))
                is com.misaka.hoshinoschedule.ui.settings.SettingsPage.Developer -> 
                    onNavigate(VoyagerSettingsScreen.Developer)
                is com.misaka.hoshinoschedule.ui.settings.SettingsPage.About -> 
                    onNavigate(VoyagerSettingsScreen.About)
            }
        },
        onBack = onBack,
